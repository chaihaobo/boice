...
export default function EditArticlePage() {
    ...
    const { data: articleResult, isLoading: isLoadingArticle } = useQuery({
    ...
    if (!article) {
        return (
            <div className="text-center py-10">
                <p className="text-muted-foreground">{t("dashboard.article_not_found")}</p>
                <Button asChild className="mt-4">
                    <Link href={`/${locale}/dashboard/articles`}>
                        <ArrowLeft className="mr-2 h-4 w-4" />
                        {t("dashboard.back_to_articles")}
                    </Link>
                </Button>
            </div>
        )
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">{t("dashboard.edit_article")}</h1>
                    <p className="text-muted-foreground mt-2">{t("dashboard.edit_article_description")}</p>
                </div>
            </div>
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            {updateMutation.isPending ? t("dashboard.saving") : t("dashboard.save_article")}
                        </Button>
                    </div>
                </div>
            </form>
